...
namespace IesYazilim.Logo.DataType.Xml
{
    public static class SerializerExtension
    {
        public static string Serialize<T>(this T data) where T : ILogoBase
        {
        ...
        public static string Serialize<T>(this List<T> data) where T : ILogoBase
        {
            if (typeof(T).GetProperty("XmlRoot") == null)
            {
