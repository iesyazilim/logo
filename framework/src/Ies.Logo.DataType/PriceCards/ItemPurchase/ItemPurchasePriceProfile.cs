...
namespace Ies.Logo.DataType.PriceCards.ItemPurchase
{
    ...
    {
        public static ItemPurchasePriceProfile Default { get; } = new ItemPurchasePriceProfile();

        private ItemPurchasePriceProfile() { }

        public IConfigurationContainer Get(IConfigurationContainer parameter)
        {
            var configuration = parameter.Type<ItemPurchasePrice>();
        ...
        public static void Configure<T>(ITypeConfiguration<T> typeConfigurations) where T : ItemPurchasePrice
        {
            ...
            typeConfigurations
                ...
                .Member(m => m.ArpAuxCode).Name("ARP_AUXCODE")
                .Member(m => m.ArpAuxCode2).Name("ARP_AUXCODE2")
                .Member(m => m.ArpAuxCode3).Name("ARP_AUXCODE3")
                .Member(m => m.ArpAuxCode4).Name("ARP_AUXCODE4")
                .Member(m => m.ArpAuxCode5).Name("ARP_AUXCODE5");
        }
    }
}
